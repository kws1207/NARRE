...
tf.flags.DEFINE_string("test_data", TPS_DIR + "/" + DATASET + "_test.csv", "Data for testing")
tf.flags.DEFINE_string("train_data", TPS_DIR + "/" + DATASET + "_train.csv", "Data for training")
tf.flags.DEFINE_string("user_review", TPS_DIR + "/" + "user_review", "User's reviews")
tf.flags.DEFINE_string("item_review", TPS_DIR + "/" + "item_review", "Item's reviews")
tf.flags.DEFINE_string("user_review_id", TPS_DIR + "/" + "user_rid", "user_review_id")
tf.flags.DEFINE_string("item_review_id", TPS_DIR + "/" + "item_rid", "item_review_id")
