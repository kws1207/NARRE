...
if (DATASET == 'automotive'):
    TP_file = os.path.join(TPS_DIR, 'reviews_Automotive_5.json')
if (DATASET == 'toys_and_games'):
    TP_file = os.path.join(TPS_DIR, 'reviews_Toys_and_Games_5.json')
...
tp_train.to_csv(os.path.join(TPS_DIR, DATASET + '_train.csv'), index=False, header=None)
tp_valid.to_csv(os.path.join(TPS_DIR, DATASET + '_valid.csv'), index=False, header=None)
tp_test.to_csv(os.path.join(TPS_DIR, DATASET + '_test.csv'), index=False, header=None)
